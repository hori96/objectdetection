...
class CustomObjectDetection:
    ...
    def detectObjectsFromImage(self, input_image="", output_image_path="", input_type="file", output_type="file",
        ...
        """
	print('faszaaaaaaaaaaaaaaaaaaaaaaa')
...
class CustomDetectionUtils:
	...
	print('VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV')
        for i in range(len(v_boxes)):
            ...
            image_frame = cv2.rectangle(image_frame, (x1, y1), (x2, y2), class_color, -1)
            ...
            if show_names or show_percentage:
                ...
                cv2.putText(image_frame, label, (b[0], b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 1, (200, 0, 0), 30)
                cv2.putText(image_frame, label, (b[0], b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 1, (255, 255, 255), 20)
